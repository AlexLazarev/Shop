                ...
                <div class="sg-nav clearfix">
                    ...
                    <ul class="sg-nav_pn">
                        <li class="sg-nav_pn__item">
                            <a class="sg-nav_pn__link" href="#">Назад</a>
                        </li>
                        <li class="sg-nav_pn__item">
                            <a class="sg-nav_pn__link" href="#">Вперед</a>
                        </li>
                    </ul>
                </div>
                <div class="sg-info">
                    ...
                    <div class="sg-info_description">
                        <div class="sg-info_description__totalinfo sg-box">
                            <div>
                                <h2 class="sg-name">Юбка миди</h2>
                                <p class="sg-vendorcode">Артикул: 005</p>
                                <p class="sg-price">1999 грн.</p>
                                <div class="sg-input">
                                    <p class="sg-input_count">Количество</p>
                                    <input value="1" ref="count" type="text">
